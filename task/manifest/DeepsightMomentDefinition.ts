...
const DeepsightMomentDefinitionData: Record<keyof typeof MomentHashes, DeepsightMomentDefinitionData> = {
	...
	Forsaken: {
		...
		primaryImage: { DestinyActivityDefinition: { hash: ActivityHashes.HighPlainsBlues_PlaceHash2961497387, property: 'pgcrImage' } },
		images: [
			{ DestinyActivityDefinition: { hash: ActivityHashes.DailyHeroicStoryMissionLastCall, property: 'pgcrImage' } },
			{ DestinyActivityDefinition: { hash: ActivityHashes.HighPlainsBlues_PlaceHash2961497387, property: 'pgcrImage' } },
	...
	SeasonOfTheForge: {
		...
		images: [
			...
			{ DestinyActivityDefinition: { hash: ActivityHashes.ScourgeOfThePast_GuidedGameUndefined, property: 'pgcrImage' } },
		],
		season: 5,
		year: 2,
	...
	SeasonOfTheChosen: {
		...
		images: [
			...
			{ DestinyActivityDefinition: { hash: ActivityHashes.ProvingGroundsCustomize1435696086, property: 'pgcrImage' } },
	...
	SeasonOfTheLost: {
		...
		primaryImage: { DestinyActivityDefinition: { hash: ActivityHashes.Exorcism_ActivityLightLevel1170, property: 'pgcrImage' } },
		images: [
			...
			{ DestinyActivityDefinition: { hash: ActivityHashes.Exorcism_ActivityLightLevel1170, property: 'pgcrImage' } },
		],
		season: 15,
		year: 4,
	...
	SeasonOfTheSeraph: {
		...
		images: [
			{ DestinyActivityDefinition: { hash: ActivityHashes.AbhorrentImperative_PlaceHash2961497387, property: 'pgcrImage' } },
			...
			{ DestinyActivityDefinition: { hash: ActivityHashes.Hierarchy_PlaceHash2961497387, property: 'pgcrImage' } },
		],
		season: 19,
		year: 5,
	...
	Lightfall: {
		...
		images: [
			{ DestinyActivityDefinition: { hash: ActivityHashes.FirstContactNormal_InsertionPointsLength2, property: 'pgcrImage' } },
	...
	SeasonOfDefiance: {
		...
		primaryImage: { DestinyActivityDefinition: { hash: ActivityHashes.DefiantBattlegroundEdz1136712465, property: 'pgcrImage' } },
		images: [
			{ DestinyActivityDefinition: { hash: ActivityHashes.DefiantBattlegroundCosmodrome2257836204, property: 'pgcrImage' } },
			{ DestinyActivityDefinition: { hash: ActivityHashes.DefiantBattlegroundEdz1136712465, property: 'pgcrImage' } },
			{ DestinyActivityDefinition: { hash: ActivityHashes.DefiantBattlegroundOrbitalPrison2290349874, property: 'pgcrImage' } },
	...
	SeasonOfTheWish: {
		...
		images: [
			...
			{ DestinyActivityDefinition: { hash: ActivityHashes.TheCoilCustomize1018673832, property: 'pgcrImage' } },
			{ DestinyActivityDefinition: { hash: ActivityHashes.Chiasmus_RequirementsUndefined, property: 'pgcrImage' } },
	...
	EdgeOfFate: {
		...
		images: [
			...
			{ DestinyActivityDefinition: { hash: ActivityHashes.TheSieve_TraitHashesLength0, property: 'pgcrImage' } },
		],
		expansion: true,
		year: 8,
	},
