...
const DeepsightMomentDefinitionData: Record<keyof typeof MomentHashes, DeepsightMomentDefinitionData> = {
	...
	SeasonOfTheChosen: {
		...
		images: [
			...
			{ DestinyActivityDefinition: { hash: ActivityHashes.ProvingGroundsCustomize_RewardsLength29, property: 'pgcrImage' } },
	...
	SeasonOfTheWish: {
		...
		images: [
			...
			{ DestinyActivityDefinition: { hash: ActivityHashes.TheCoilCustomize_ModifiersLength7, property: 'pgcrImage' } },
