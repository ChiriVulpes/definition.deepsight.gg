...
const EXCLUDED_PATHS: Partial<Record<keyof AllDestinyManifestComponents, string[]>> = {
	DestinyInventoryItemDefinition: [
		...
		'quality.currentVersion', 'displayProperties.iconHash',
	],
	...
	DestinyPresentationNodeDefinition: ['children.*', 'objectiveHash', 'maxCategoryRecordScore', 'originalIcon', 'rootViewIcon'],
